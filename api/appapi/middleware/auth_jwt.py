...
from appapi.models.user_model import User  # Adjust the import path based on your project structure
from appapi.config.auth_config import SECRET_KEY  # Ensure this matches your actual config path
